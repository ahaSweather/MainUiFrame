...
public class StatusBarUtil {
     ...
     */
    @TargetApi(Build.VERSION_CODES.M)
    public static void setLightModeWithLayoutFullScreen(Activity activity) {
        setTransparentForWindow(activity);
        setMIUIStatusBarDarkIcon(activity, true);
        setMeizuStatusBarDarkIcon(activity, true);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
     ...
     */
    @TargetApi(Build.VERSION_CODES.M)
    public static void setDarkModeWithLayoutFullScreen(Activity activity) {
        setTransparentForWindow(activity);
        setMIUIStatusBarDarkIcon(activity, false);
        setMeizuStatusBarDarkIcon(activity, false);
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.M)
    public static void setDarkModeWithLayout(Activity activity) {
//        setTransparentForWindow(activity);
        setColor(activity,activity.getResources().getColor(R.color.black),255);
        setMIUIStatusBarDarkIcon(activity, false);
        setMeizuStatusBarDarkIcon(activity, false);
        activity.getWindow().getDecorView().setSystemUiVisibility(
                View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
