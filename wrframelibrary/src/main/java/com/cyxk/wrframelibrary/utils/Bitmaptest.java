...
public class Bitmaptest {
     ...
     * @return
     */
    public static Bitmap decodeStream(Context context, Uri uri, float size) {
        Bitmap image = null;
        try {
            Uri dataUri = uri;
            // 获取原图宽度
...
//        screenshot = Bitmap.createBitmap(v.getWidth(), height , Config.RGB_565);
...
//        return screenshot;
    ...
    public static Bitmap newBitmap(Bitmap bit1,Bitmap bit2){
        ...
        SoftReference<Bitmap> reference = new SoftReference<>(Bitmap.createBitmap(width, height, Config.RGB_565));
